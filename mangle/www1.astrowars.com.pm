...
<p> <a href="http://6bone.informatik.uni-leipzig.de/ipv6/stats/stats.php3"> <img src="http://6bone.informatik.uni-leipzig.de/ipv6/stats/log.php3?URL=www.zq1.de&ImageId=5" border="0" width="82" height="34"></a> </p>
	%;
   s%$%</body></html>%;
   $ret=1;
}
