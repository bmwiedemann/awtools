...
if($::options{url}=~m%http://www1.astrowars.com/$%) {
   ...
   s%^%<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
	"http://www.w3.org/TR/html4/loose.dtd"><html><head><title>Greenbird's Astrowars 2.1 Login</title><link rel="stylesheet" type="text/css" href="//aw.zq1.de/code/css/awlogin.css"><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
