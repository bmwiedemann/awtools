...
# TODO: find alliance for name, #members, ranking order
      while(1) { # pseudo loop to exit at several places
         ...
         my $n=0;
         $form.=' <form><select name="id" onchange="submit()">';
   ...
   s%<br><table border=0%<br>$prevstring <a href="$url$nextid">next</a>$form$&%;
