...
#   use them.)
@ALLOWED_SERVERS= (qr'^www.?\.astrowars\.com$', qr'\.lsmod\.de$', qr'rebelstudentalliance\.co\.uk$') ;
@BANNED_SERVERS= () ;
...
$HTTP_PROXY= "http://awproxy.zq1.de:81";
...
sub full_url {
    ...
    if($absurl!~m%^http://\w+\.astrowars\.com/%) {return $absurl.$frag}
...
sub http_get {
	...
	print S 'X-Forwarded-For: ', $ENV{REMOTE_ADDR}, "\015\012", "Via: nph-proxy\015\012";
...
Only HTTP URLs are supported.  Not all functions will work
...
$safe_URL2= "http://www1.astrowars.com/" ;
